...
const tracks = {
    ...
    '124': {
        title: 'Боль внутри',
        artist: 'Y U R R V C H',
        image: 'https://avatars.mds.yandex.net/i?id=21525d6ef3de978896afdab3f682c8b67a1a1360-10126215-images-thumbs&n=13',
        audio: 'https://files.catbox.moe/sra83h.mp3',
        duration: '150',
        lyrics: [
            { text: "Твои карие глазки очень безупречны", time: 17 },
            { text: "Лишь увидев я их утопаю навечно", time: 19 },
            { text: "Ты бы знала как сильно я их люблю", time: 22 },
            { text: "Моя любовь к ним бесконечна", time: 26 },
            { text: "Ты сияешь ярче солнца, и небес", time: 27 },
            { text: "Ты красива даже звёзд, и чудес", time: 29 },
            { text: "Ты как в сказке представляю я себе", time: 31 },
            { text: "Эта песня посвещается одной тебе", time: 33 },
            { text: "Помню все минуты, каждые секунды дня", time: 37 },
            { text: "Когда ты говорила как же у тебя дела?)", time: 39 },
            { text: "Мне никогда не забыть те голоса", time: 40 },
            { text: "Ведь твои голоса, сохранились навсегда", time: 43 },
            { text: "Она чуть ниже меня и это так мило", time: 46 },
            { text: "И ее взгляд влюбляет очень сильно", time: 48 },
            { text: "Обожаю как она говорит ауч", time: 50 },
            { text: "И обнимает меня очень крепко", time: 52 },
            { text: "Летом зимой мне так не хватало, так не хватало тебя", time: 55 },
            { text: "Будто улечу куда-то, я далеко на небеса", time: 60 },
            { text: "В моём сердечке одна только ты", time: 63 },
            { text: "Кроме тебя нету там никого", time: 66 },
            { text: "Я не брошу тебя, не оставлю", time: 68 },
            { text: "И не планирую тебя потерять", time: 70 },
            { text: "Как только ты появилась в моей жизни", time: 73 },
            { text: "Украсила ее в разы сильно", time: 75 },
            { text: "Я не забуду твои слова, твою поддержу", time: 78 },
            { text: "И как мы вместе общались до утра", time: 80 },
            { text: "Жаным давай напишем роман", time: 82 },
            { text: "Где мы с тобой, и нету обмана", time: 85 },
            { text: "Жаным побудь, ты со мной рядом", time: 86 },
            { text: "Прошу тебя очень, побудь со мной рядом", time: 88 },
            { text: "Жаным прошу согрей же сильней", time: 91 },
            { text: "Чтобы почувствовать себя живее", time: 93 },
            { text: "Ведь я без тебя жить не могу", time: 95 },
            { text: "Будто живу без кислорода", time: 98 },
            { text: "Жаным, ты бей сил не жалей", time: 110 },
            { text: "Сделай же снова больно сильней", time: 113 },
            { text: "В сердце ты жги, как пламя в огне", time: 115 },
            { text: "В сердце ты жги, как пламя в огне", time: 119 },
            { text: "Жаным, давай дарить миру свет", time: 120 },
            { text: "В нашем романе скажем нет темноте", time: 122 },
            { text: "Ты и я, вечная история", time: 125 },
            { text: "На века с тобой, вечная любовь и история", time: 127 },
        ],
        similar: ['125', '25', '48', '145', '134', '124', '197']
    },
    '125': {
        title: 'Qyz Bozbala',
        artist: 'Marhaba Sabi',
        image: 'https://avatars.mds.yandex.net/i?id=6304dcbb5ef4ccc1d4e67e16c4e30f1fac50af21-5869782-images-thumbs&n=13',
        audio: 'https://files.catbox.moe/q34td7.mp3',
        duration: '189',
        lyrics: [
            { text: "Текста нету", time: 0 },
        ],
        similar: ['126', '36', '44', '128', '142', '194', '34']
    },
    '126': {
        title: 'Keіркеr',
        artist: 'Ernar Amandyq',
        image: 'https://avatars.mds.yandex.net/i?id=b091c67b06531841eddcff95a0f81c4c204d2443-8184802-images-thumbs&n=13',
        audio: 'https://files.catbox.moe/68qd4g.mp3',
        duration: '204',
        lyrics: [
            { text: "Текста нету", time: 0 },
        ],
        similar: ['127', '35', '12', '134', '135', '137', '111']
    },
    '127': {
        title: 'Капкан',
        artist: 'MOT',
        image: 'https://avatars.mds.yandex.net/i?id=ddb7b373a61e8b822ae6d6085ed1da75969a4f4b-4416246-images-thumbs&n=13',
        audio: 'https://files.catbox.moe/77yeyt.mp3',
        duration: '229',
        lyrics: [
            { text: "Текста нету", time: 0 },
        ],
        similar: ['128', '35', '174', '167', '34', '14', '23']
    },
    '128': {
        title: 'Уйду',
        artist: 'Xcho',
        image: 'https://avatars.mds.yandex.net/i?id=804682f4678eac8e7707a3df56555e319cf1a423-5906571-images-thumbs&n=13',
        audio: 'https://files.catbox.moe/7p1al6.mp3',
        duration: '145',
        lyrics: [
            { text: "Текста нету", time: 0 },
        ],
        similar: ['129', '26', '98', '75', '48', '55', '77']
    },
    '129': {
        title: 'Антигерой',
        artist: 'ELMAN',
        image: 'https://avatars.mds.yandex.net/i?id=7f5d2a2c4b8202e88167c6d9e9ac7e26f9c1490e-3891756-images-thumbs&n=13',
        audio: 'https://files.catbox.moe/iq804s.mp3',
        duration: '165',
        lyrics: [
            { text: "Текста нету", time: 0 },
        ],
        similar: ['130', '14', '147', '156', '192', '193', '173']
    },
    '130': {
        title: 'Не прощайся',
        artist: 'Nuricko',
        image: 'https://avatars.mds.yandex.net/i?id=f11c940f47e9a8c98a7ab3a70359c5aa41982fd3-5216657-images-thumbs&n=13',
        audio: 'https://files.catbox.moe/15dwk9.mp3',
        duration: '206',
        lyrics: [
            { text: "Текста нету", time: 0 },
        ],
        similar: ['131', '43', '41', '47', '46', '42', '49']
    },
    '131': {
        title: '10',
        artist: 'Эндшпиль',
        image: 'https://avatars.mds.yandex.net/i?id=2a00000198939e8daeb1c8c59767fa596988-475612-fast-images&n=13',
        audio: 'https://files.catbox.moe/d66d4n.mp3',
        duration: '164',
        lyrics: [
            { text: "Текста нету", time: 0 },
        ],
        similar: ['132', '35', '39', '31', '35', '36', '33']
    },
    '132': {
        title: 'Кино',
        artist: 'MACAN',
        image: 'https://avatars.mds.yandex.net/i?id=8ddb19f59fcf60cf1e1cfee9a7fbb8d1c63cc529-5887817-images-thumbs&n=13',
        audio: 'https://files.catbox.moe/wxf4td.mp3',
        duration: '184',
        lyrics: [
            { text: "Текста нету", time: 0 },
        ],
        similar: ['133', '75', '71', '79', '76', '74', '70']
    },
    '133': {
        title: 'Untouchable',
        artist: 'MiyaGi & "Эндшипиль, Рем Дигга',
        image: 'https://avatars.mds.yandex.net/i?id=7f7fa46bb93f2cec4f2acb098fb57f651da0d0e4-4478670-images-thumbs&n=13',
        audio: 'https://files.catbox.moe/vi5yce.mp3',
        duration: '213',
        lyrics: [
            { text: "Текста нету", time: 0 },
        ],
        similar: ['134', '105', '184', '186', '147', '87', '77']
    },
    '134': {
        title: 'Не интересно',
        artist: 'V$XVPRiNCE',
        image: 'https://avatars.mds.yandex.net/i?id=f194dbe3ba7b2e9b8f7a78f87f5d8e3da0ef0ec8-9271342-images-thumbs&n=13',
        audio: 'https://files.catbox.moe/ap74ip.mp3',
        duration: '167',
        lyrics: [
            { text: "Текста нету", time: 0 },
        ],
        similar: ['135', '35', '147', '75', '94', '54', '25']
    },
    '135': {
        title: 'Unaisyn',
        artist: 'De Lacure, Ирина Кайратовна',
        image: 'https://avatars.mds.yandex.net/i?id=3dd7201cc1de652be792b6fab04881a804ee3c0c-9843573-images-thumbs&n=13',
        audio: 'https://files.catbox.moe/caiq7v.mp3',
        duration: '260',
        lyrics: [
            { text: "Текста нету", time: 0 },
        ],
        similar: ['136', '38', '52', '53', '57', '74', '175']
    },
    '136': {
        title: 'Zhauap Bar Ma?',
        artist: 'Moldanazar',
        image: 'https://avatars.mds.yandex.net/i?id=4b952c3eb40f44e09eb0d2bb05b4b49ce8bd72c9-16291885-images-thumbs&n=13',
        audio: 'https://files.catbox.moe/jmdacp.mp3',
        duration: '236',
        lyrics: [
            { text: "Текста нету", time: 0 },
        ],
        similar: ['137', '64', '58', '51', '24', '147', '35']
    },
    '137': {
        title: 'Грустный эконом',
        artist: 'PIZZA, NAVAI',
        image: 'https://avatars.mds.yandex.net/i?id=94d2f64bfbfa328e09f0684453a7cfa1d3d84839-5887331-images-thumbs&n=13',
        audio: 'https://files.catbox.moe/2v42iv.mp3',
        duration: '218',
        lyrics: [
            { text: "Текста нету", time: 0 },
        ],
        similar: ['138', '158', '12', '75', '21', '84', '37']
    },
    '138': {
        title: 'AKETESIN',
        artist: 'De Lacure, V$XVPRINCE',
        image: 'https://avatars.mds.yandex.net/i?id=c51eb7389b32947ad861ef81557a11b642e2e8e4-5645229-images-thumbs&n=13',
        audio: 'https://files.catbox.moe/uqzrpa.mp3',
        duration: '197',
        lyrics: [
            { text: "Текста нету", time: 0 },
        ],
        similar: ['139', '35', '74', '44', '157', '97', '23']
    },
    '139': {
        title: 'Музыка Любви',
        artist: '',
